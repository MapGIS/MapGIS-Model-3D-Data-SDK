...
const textureResolutionScratch = new Cesium.Cartesian2();
 ...
 * @private
 */
export default function getClippingFunction(clippingPlaneCollection, context) {
    // >>includeStart('debug', pragmas.debug);
    Cesium.Check.typeOf.object('clippingPlaneCollection', clippingPlaneCollection);
    Cesium.Check.typeOf.object('context', context);
    // >>includeEnd('debug');
...
CesiumZondy.M3D.getClippingFunction = getClippingFunction;
