 ...
 * @private
 */
export default function getClipAndStyleCode(samplerUniformName, matrixUniformName, styleUniformName) {
    // >>includeStart('debug', pragmas.debug);
    Cesium.Check.typeOf.string('samplerUniformName', samplerUniformName);
    Cesium.Check.typeOf.string('matrixUniformName', matrixUniformName);
    Cesium.Check.typeOf.string('styleUniformName', styleUniformName);
    // >>includeEnd('debug');
...
CesiumZondy.M3D.getClipAndStyleCode = getClipAndStyleCode;
