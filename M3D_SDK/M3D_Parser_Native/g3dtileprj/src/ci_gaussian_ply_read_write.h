...
//================================================================================
/// PLY格式高斯数据读写类
/// 继承自CGGaussianReadWrite，实现对PLY格式高斯数据的读写操作
//================================================================================
class Ci_PlyGaussianReadWrite : public MapGIS::Tile::CGGaussianReadWrite
{
public:
	//================================================================================
	/// 默认构造函数
	//================================================================================
	Ci_PlyGaussianReadWrite()
	{
	};
	...
	/// 虚析构函数
	//================================================================================
	virtual ~Ci_PlyGaussianReadWrite() {};

protected:
	//================================================================================
	/// 内部读取接口实现
	/// 从指定PLY文件路径读取高斯数据到数据模型
	///
	...
	//================================================================================
	/// 内部回调读取接口实现
	/// 从指定PLY文件路径读取高斯数据，通过回调函数逐个处理特征点
	///
	/// @param [in] filePath  文件路径
