...
struct PackedGaussians {
  ...
  UnpackedGaussian unpack(int32_t i, const  MapGIS::Tile::CoordinateSystemConverter &c) const;
};

struct PackOptions {
	MapGIS::Tile::CoordinateSystem from = MapGIS::Tile::CoordinateSystem::UNSPECIFIED;
};

struct UnpackOptions {
	MapGIS::Tile::CoordinateSystem to = MapGIS::Tile::CoordinateSystem::UNSPECIFIED;
};
